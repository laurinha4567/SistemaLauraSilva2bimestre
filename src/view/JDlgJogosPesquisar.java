...
public class JDlgJogosPesquisar extends javax.swing.JDialog {
     ...
     */
    public JDlgJogosPesquisar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void JBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBtnOkActionPerformed
       ...
       if (jTable1.getSelectedRow() == -1) {
            ...
            LfsJogos lfsjogos = controlerJogos.getBean(jTable1.getSelectedRow());
            jDlgJogos.beanView(lfsjogos);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgJogosPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgJogosPesquisar dialog = new JDlgJogosPesquisar(new javax.swing.JFrame(), true);
